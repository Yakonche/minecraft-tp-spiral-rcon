...
def rebuild_state_from_steps(base: SpiralState, n:int)->SpiralState:
    s=SpiralState(player=base.player,dimension=base.dimension,y=base.y,chunk_step=base.chunk_step,step_blocks=base.step_blocks,spawn_x=base.spawn_x,spawn_z=base.spawn_z,current_x=base.spawn_x,current_z=base.spawn_z,step_index=0,dir_idx=0,leg_length=1,leg_progress=0,interval_s=base.interval_s,max_tps=base.max_tps,host=base.host,port=base.port)
    for _ in range(n):
        _,_,s=next_step(s)
    return s
