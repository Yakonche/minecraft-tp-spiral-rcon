...
DEFAULT_CONFIG = {
    "rcon": {"host": "localhost", "port": 25575, "password": "Password", "timeout": 5.0},
    "exploration": {
        "player": "Player",
    ...
    "save_file": "auto",
    "save_dir": "saves",
    "nbt": {"playerdata": "/srv/minecraft/world/playerdata", "usernamecache": "/srv/minecraft/usernamecache.json"},
}
